...
const TunInboundSchema = InboundBaseSchema.extend({
  ...
  iproute2_table_index: z.int().optional(),
  iproute2_rule_index: z.int().optional(),
  ...
  include_uid: z.array(z.int()).optional(),
  include_uid_range: z.array(z.string()).optional(),
  exclude_uid: z.array(z.int()).optional(),
  exclude_uid_range: z.array(z.string()).optional(),
  include_android_user: z.array(z.int()).optional(),
