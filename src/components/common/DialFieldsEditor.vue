...
const domainResolver = computed({
    get: () =>
        typeof dialFields.value.domain_resolver === "string"
            ? dialFields.value.domain_resolver
            : "",
    set: (value) => {
    ...
    <Fieldset legend="Dial Fields" :toggleable="true" :collapsed="true">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <label for="detour" class="block mb-2 font-medium"
                        >Detour</label
                    >
                ...
                <div>
                    <label for="bind_interface" class="block mb-2 font-medium"
                        >Bind Interface</label
                    >
                    <InputText
                        id="bind_interface"
                ...
                <div>
                    <label
                        for="inet4_bind_address"
                        class="block mb-2 font-medium"
                        >IPv4 Bind Address</label
                    >
                    <InputText
                ...
                <div>
                    <label
                        for="inet6_bind_address"
                        class="block mb-2 font-medium"
                        >IPv6 Bind Address</label
                    >
                    <InputText
                ...
                <div>
                    <label for="routing_mark" class="block mb-2 font-medium"
                        >Routing Mark</label
                    >
                    <InputNumber
                        id="routing_mark"
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <label for="connect_timeout" class="block mb-2 font-medium"
                ...
                <div>
                    <label for="domain_resolver" class="block mb-2 font-medium"
                        >Domain Resolver</label
                    >
                    <InputText
                        id="domain_resolver"
                ...
                <div>
                    <label for="domain_strategy" class="block mb-2 font-medium"
                        >Domain Strategy</label
                    >
                    <Select
                        id="domain_strategy"
                ...
                <div class="flex flex-col gap-3 mt-2">
                    <div class="flex items-center gap-2">
                        ...
                        />
                        <label for="reuse_addr" class="cursor-pointer"
                            >Reuse Address</label
                        >
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <input
                            ...
                            class="cursor-pointer"
                        />
                        <label for="tcp_fast_open" class="cursor-pointer"
                            >TCP Fast Open</label
                        >
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <input
                            ...
                            class="cursor-pointer"
                        />
                        <label for="tcp_multi_path" class="cursor-pointer"
                            >TCP Multi Path</label
                        >
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <input
                            ...
                            class="cursor-pointer"
                        />
                        <label for="udp_fragment" class="cursor-pointer"
                            >UDP Fragment</label
                        >
                    </div>
                </div>
